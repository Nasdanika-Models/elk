...
import org.nasdanika.models.elk.ecore.EcoreGenElkProcessorsFactory;
 ...
 *
 */
public class TestElkModelDocGen {
	
	@Test
	public void testGenerateElkModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenElkProcessorsFactory ecoreGenElkProcessorFactory = new EcoreGenElkProcessorsFactory(context);		
		EcoreNodeProcessorFactory ecoreNodeProcessorFactory = new EcoreNodeProcessorFactory(
				...
				diagnosticConsumer,
				ecoreGenElkProcessorFactory);
		
		File actionModelsDir = new File("target\\action-models\\");
		actionModelsDir.mkdirs();
		File output = new File(actionModelsDir, "elk.xmi");		
		...
		String siteMapDomain = "https://elk.models.nasdanika.org";		
